...
abstract class DMTService {
  ...
  Future<DmtTransaction> updateTransactionStatus(
      @Path("transaction_id") int transactionId, @Body() String status);
  ...
  Future<CreateSenderResponse> createSender(@Body() CreateSenderRequest senderRequest);

  @POST("sampurna_api/verify_sender")
  Future<VerifySenderResponse> verifySender(@Body() VerifySenderRequest request);

  @POST("sampurna_api/verify_account")
  Future<VerifyAccountResponse> verifyAccount(@Body() VerifyAccountRequest request);

  @POST("sampurna_api/add_beneficiary")
  Future<AddBeneficiaryResponse> addBeneficiary(@Body() AddBeneficiaryRequest request);

  @POST("sampurna_api/get_beneficiary")
  Future<GetBeneficiaryResponse> getBeneficiary(@Query("mobile_no") String mobileNo,@Query("reference_id") String referenceId);
