        ...
        builder: (context, state) {
          if (state is LoadTransactionsSuccessful) {
            ...
            final userDataSource = DmtTransactionsDataSource(
                ...
                }, onEditClick: (int id) {  }, onDeleteClick: (int id) {  }, items:transactions);
            return Padding(
              ...
              child: SfDataGridTheme(
                ...
                child: SfDataGrid(
                    ...
                    columns: <GridColumn>[
                      ...
                      GridColumn(
                          allowFiltering: false,
                          columnName: 'sender_mobile_no',
                          columnWidthMode: ColumnWidthMode.auto,
                          label: Container(
                              alignment: Alignment.centerLeft,
                              padding: const EdgeInsets.symmetric(horizontal: 8),
                              child: const Text('Customer Mobile No.'))),*/
                      GridColumn(
                          allowFiltering: false,
                          columnName: 'customer',
                          columnWidthMode: ColumnWidthMode.auto,
                      ...
                      /*GridColumn(
                          ...
                          label: Container(
                              alignment: Alignment.centerLeft,
                              padding: const EdgeInsets.symmetric(horizontal: 8),
                              child: const Text('Beneficiary ID'))),
                      GridColumn(
                          allowFiltering: false,
                          ...
                          label: Container(
                              alignment: Alignment.centerLeft,
                              padding: const EdgeInsets.symmetric(horizontal: 8),
                              child: const Text('Beneficiary Name'))),
                      GridColumn(
                          allowFiltering: false,
                      ...
                      GridColumn(
                          ...
                          label: Container(
                              alignment: Alignment.centerLeft,
                              padding: const EdgeInsets.symmetric(horizontal: 8),
                              child: const Text('Retailer'))),GridColumn(
                          allowFiltering: false,
                          columnName: 'vendor',
                          columnWidthMode: ColumnWidthMode.auto,
                          label: Container(
