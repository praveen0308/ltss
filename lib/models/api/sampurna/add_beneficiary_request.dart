class AddBeneficiaryRequest {
  ...
  AddBeneficiaryRequest.fromJson(dynamic json) {
  ...
  String? token;
  int? outletID;
AddBeneficiaryRequest copyWith({  String? beneName,
  String? beneMobile,
  String? beneAccountNumber,
  String? bankName,
  String? ifsc,
  ...
  String? token,
  int? outletID,
}) => AddBeneficiaryRequest(  beneName: beneName ?? this.beneName,
  beneMobile: beneMobile ?? this.beneMobile,
